...
const LoginPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setErrorMessage(
          result.message || "Something went wrong when trying to log in."
        )
      }
    } catch (err) {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold mb-4 text-center text-customBrown font-lilita">
        Welcome back
      </h2>
      ...
      >
        ...
        <Button
          type="submit"
          className="text-center bg-customBrown hover:bg-customDarkBrown"
        >
          Login
        </Button>
